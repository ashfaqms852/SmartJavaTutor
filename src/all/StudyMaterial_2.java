...
public class StudyMaterial_2 extends JFrame {
    ...
    public StudyMaterial_2() {
        super("StudyMaterials-Slides");     
        setLayout(new BorderLayout());
        next = new JButton("Next");
        previous = new JButton("Previous");
        switch(Login.currT) {
            case 1 : image = new ImageIcon(getClass().getResource("images//1-2.jpg"));
                    break;
            case 2 : image = new ImageIcon(getClass().getResource("images//2-2.jpg"));
                    break;
            case 3 : image = new ImageIcon(getClass().getResource("images//3-2.jpg"));
                    break;
            default : break;    
        }
